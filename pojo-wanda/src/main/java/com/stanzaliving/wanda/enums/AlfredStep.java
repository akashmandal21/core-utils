...
public enum AlfredStep {
	...
	ONBOARDING(5, Arrays.asList("AGREEMENT PENDING","AWAITING CONFIRMATION")),
	AGREEMENT(6, Arrays.asList("AGREEMENT SENT")),
	KYC(7, Arrays.asList("ONBOARDING PENDING", "ONBOARDING IN PROGRESS")),
	KYC_REJECTED(8,Arrays.asList("KYC REJECTED")),
	UPDATE_BY_SALES_POC(9, Arrays.asList("NEEDS ATTENTION")),
	HOMESCREEN(10, Arrays.asList("REFUND INITIATED","ONBOARDING COMPLETED","VERIFICATION PENDING", "GUEST ONBOARDING COMPLETED")),
	SECOND_AGREEMENT(11,Arrays.asList("SUBCONTRACT 2 AGREEMENT SENT")),
	RETENTION_BOOKING(12,Arrays.asList("RETENTION BOOKING")),
	CONTRACT_MODIFICATION_PENDING(13,Arrays.asList("CONTRACT MODIFICATION PENDING")),
	SELFIE(14,Arrays.asList("SELFIE")),
	GUEST_ONBOARDING(15, Arrays.asList("GUEST_ONBOARDING")),
	GUEST_UNDERTAKING(16, Arrays.asList("GUEST_UNDERTAKING")),
	GUEST_KYC(17, Arrays.asList("GUEST_KYC")),
	GUEST_SELFIE(18, Arrays.asList("GUEST_SELFIE")),
	GUEST_ONBOARDING_PENDING(19, Arrays.asList("HOMESCREEN"));
