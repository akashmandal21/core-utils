...
public enum AlfredStep {
	...
	ONBOARDING(3, Arrays.asList("AWAITING CONFIRMATION")),
	AGREEMENT(4, Arrays.asList("AGREEMENT SENT")),
	KYC(5, Arrays.asList("ONBOARDING PENDING", "ONBOARDING IN PROGRESS","VERIFICATION PENDING")),
