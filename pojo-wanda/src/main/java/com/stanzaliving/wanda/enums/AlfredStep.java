...
public enum AlfredStep {
	...
	UPDATE_BY_SALES_POC(1, Arrays.asList("NEEDS ATTENTION")),
	SELFBOOKING(2, Arrays.asList("SHARED WITH RESIDENT")),
	PAYMENT_PENDING(3, Arrays.asList("PAYMENT PENDING")),
	PAYMENT_COLLECTION_PENDING(4,Arrays.asList("COLLECT PAYMENT FROM RESIDENT")),
	ONBOARDING(5, Arrays.asList("AWAITING CONFIRMATION")),
	AGREEMENT(6, Arrays.asList("AGREEMENT SENT")),
	KYC(7, Arrays.asList("ONBOARDING PENDING", "ONBOARDING IN PROGRESS","VERIFICATION PENDING")),
