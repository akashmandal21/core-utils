package com.stanzaliving.analytics.logs.utils;
...
public final class AnalyticConfigReader
{
    ...
    private static final String DEFAULT_ENDPOINT_CLASS = "com.stanzaliving.analytics.logs.endpoint.impl.LogEndpoint";
