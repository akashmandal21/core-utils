...
import com.stanzaliving.analytics.logs.endpoint.Endpoint;
import com.stanzaliving.analytics.logs.endpoint.EndpointHelper;
import com.stanzaliving.analytics.logs.expression.Expression;
import com.stanzaliving.analytics.logs.expression.ExpressionBuilderHelper;
...
public class AnalyticService
{
    ...
    private static Map<String, ClassMembers> analyticCache = new Hashtable<String, ClassMembers>() {
        ...
        public String toString()
        {
            ...
            for (Entry<String, ClassMembers> entry : this.entrySet())
            {
