...
public enum ApprovalStatus {
    PENDING_L1_APPROVAL("Pending L1 Approval",1, ColorCode.LIGHT_GRAYISH_PINK.getColorCode(), ColorCode.VERY_DARK_GRAYISH_CYAN.getColorCode(), ColorCode.GRAYISH_RED.getColorCode(), "Successfully Submitted for L1 Approval"),
    ...
    PENDING_L2_APPROVAL("Pending L2 Approval",2, ColorCode.LIGHT_GRAYISH_ORANGE.getColorCode(), ColorCode.VERY_DARK_GRAYISH_CYAN.getColorCode(), ColorCode.VERY_SOFT_ORANGE.getColorCode(),"Successfully Submitted for L2 Approval"),
    ...
    PENDING_L3_APPROVAL("Pending L3 Approval", 3, ColorCode.VERY_PALE_MOSTLY_WHITE_VIOLET.getColorCode(), ColorCode.VERY_DARK_GRAYISH_CYAN.getColorCode(), ColorCode.STRONG_VIOLET.getColorCode(), "Successfully Submitted for L3 Approval"),
    ...
    PENDING_L4_APPROVAL("Pending L4 Approval", 4, ColorCode.VERY_PALE_MOSTLY_WHITE_BLUE.getColorCode(), ColorCode.VERY_DARK_GRAYISH_CYAN.getColorCode(), ColorCode.VERY_LIGHT_BLUE.getColorCode(),"Successfully Submitted for L4 Approval"),
    ...
    PENDING_L5_APPROVAL("Pending L5 Approval", 5, ColorCode.PALE_ORANGE.getColorCode(), ColorCode.VERY_DARK_GRAYISH_CYAN.getColorCode(), ColorCode.VIVID_ORANGE.getColorCode(), "Successfully Submitted for L5 Approval"),
