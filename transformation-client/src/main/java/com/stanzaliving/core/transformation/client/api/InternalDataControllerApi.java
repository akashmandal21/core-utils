...
public class InternalDataControllerApi {
    ...
    public ResponseDto<Void> dropResidenceProperty(String propertyUuid) {
        ...
        String path = UriComponentsBuilder.fromPath("/internal/residence/drop/residence/{propertyUuid}").buildAndExpand(uriVariables).toUriString();
