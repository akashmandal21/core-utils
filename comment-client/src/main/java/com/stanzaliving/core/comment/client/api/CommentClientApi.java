...
public class CommentClientApi {
	...
	public ResponseDto<List<CommentsDto>> getLatestCommentForContextId(String contextId) {
		...
		String path = UriComponentsBuilder.fromPath("/internal/get/latest/{contextId}").buildAndExpand(uriVariables).toUriString();
