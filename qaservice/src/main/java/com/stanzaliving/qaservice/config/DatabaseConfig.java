package com.stanzaliving.qaservice.config;
...
import com.stanzaliving.core.sqljpa.CustomJpaVendor;
import com.stanzaliving.core.sqljpa.JpaConfigUtil;
import com.stanzaliving.core.sqljpa.RoutingDataSource;
...
@EnableJpaRepositories(
		...
		basePackages = "com.stanzaliving.qaservice.repository")
...
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManager() throws PropertyVetoException {
		...
		entityManagerFactory.setPackagesToScan("com.stanzaliving.capexestimator.entity");
