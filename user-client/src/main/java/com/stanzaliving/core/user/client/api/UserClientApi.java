...
public class UserClientApi {
	...
	public ResponseDto<List<UserDeptLevelRoleNameUrlExpandedDto>> getUserRolesByDepartment(String userUuid) {
		...
		String path = UriComponentsBuilder.fromPath("/acl/user/be/{userId}").buildAndExpand(uriVariables).toUriString();
