...
public class UserClientApi {
	...
	public PageResponse<UserContactDetailsResponseDto> getUserContactDetailsByRoleParams(UserRoleSearchDto userRoleSearchDto) {
		final Map<String, Object> uriVariables = new HashMap<>();
		...
		ParameterizedTypeReference<PageResponse<UserContactDetailsResponseDto>> userContactResponse = new ParameterizedTypeReference<PageResponse<UserContactDetailsResponseDto>>() {};
