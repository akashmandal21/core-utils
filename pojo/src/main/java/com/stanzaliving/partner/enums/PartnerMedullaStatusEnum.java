...
public enum PartnerMedullaStatusEnum {
    ...
    ACCEPTED_BY_VENDOR("Accepted", ImmutableSet.of("Accepted By Vendor", "GSRI Closed"), "#60C3AD", "#EDFFF5"),
    REJECTED_BY_VENDOR("Rejected", ImmutableSet.of("Rejected By Vendor"), "#FF5238", "#FFE5E1"),
    L3_CANCELLED("Cancelled", ImmutableSet.of("Cancelled"), "#60C3AD", "#EDFFF5"),
    ...
    ON_HOLD("On Hold", ImmutableSet.of("Cancel L1 Due", "Cancel L2 Due", "Cancel L3 Due"), "#60C3AD", "#EDFFF5"),
