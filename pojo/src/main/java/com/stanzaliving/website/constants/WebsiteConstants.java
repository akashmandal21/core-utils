...
public class WebsiteConstants {
	...
	public static final String LUID = "luid"; // locally unique identifier

	public static final String RESIDENCE_TYPE_HEADER = "X-residenceType";
	
	public static final String STANZA_SESSION = "stanza_session";
