...
public class WebsiteSelfRefundPageConstants {
	...
	public final String ZERO_PREBOOKING_TRANSACTION_FOUND_MESSAGE = "No bookings found in your name.<br />Don't worry, it's not too late. Initiate the pre-booking process by clicking here.";
	...
	public final String SELF_REFUND_REQUEST_ALREADY_RAISED_MESSAGE = "Your refund request already exists (Reference Number: %s).<br />The amount will reach your account within the next %s days.";
