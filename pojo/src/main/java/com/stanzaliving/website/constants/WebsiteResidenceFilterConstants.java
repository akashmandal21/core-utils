...
public class WebsiteResidenceFilterConstants {
	...
	public final Integer FILTER_SORT_BY_SEQUENCE_ID = 1;
	...
	public final Integer FILTER_LOCALITY_SEQUENCE_ID = 2;
	public final String FILTER_LOCALITY_NAME = "Locality";

	public final Integer FILTER_PRICE_SEQUENCE_ID = 3;
	...
	public final Integer FILTER_RESIDENCE_TYPE_SEQUENCE_ID = 5;
	...
	public final Integer FILTER_OCCUPANCY_SEQUENCE_ID = 6;
	public final String FILTER_OCCUPANCY_NAME = "Occupancy";
	
	public final Integer FILTER_AMENITIES_SEQUENCE_ID = 7;
	public final String FILTER_AMENITIES_NAME = "Amenities";

	public final Integer FILTER_SERVICES_SEQUENCE_ID = 8;
