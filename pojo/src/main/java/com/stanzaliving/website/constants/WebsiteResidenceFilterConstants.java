...
public class WebsiteResidenceFilterConstants {
	...
	public final Integer FILTER_LOCALITY_SEQUENCE_ID_V2 = 1;
	public final String FILTER_LOCALITY_NAME = "Locality";

	public final Integer FILTER_PRICE_SEQUENCE_ID = 4;
	public final Integer FILTER_PRICE_SEQUENCE_ID_V2 = 2;
	...
	public final Integer FILTER_GENDER_SEQUENCE_ID_V2 = 4;
	...
	public final Integer FILTER_OCCUPANCY_SEQUENCE_ID_V2 = 3;
	public final String FILTER_OCCUPANCY_NAME = "Occupancy";
	
	public final Integer FILTER_AMENITIES_SEQUENCE_ID = 8;
	public final Integer FILTER_AMENITIES_SEQUENCE_ID_V2 = 1;
