...
public enum PoStatus {
    ...
    WORK_COMPLETED("GRN Work Completed", 3, Arrays.asList(Department.FINANCE,Department.DESIGN, Department.PROCUREMENT, Department.GC, Department.TRANSFORMATIONS, Department.SALES), "#F1F3C2", "#898F07"),
