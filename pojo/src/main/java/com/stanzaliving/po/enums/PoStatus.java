...
public enum PoStatus {
    ...
    INVOICE_SUBMITTED("Invoice Submitted", 4, Arrays.asList(Department.DESIGN, Department.PROCUREMENT, Department.TRANSFORMATIONS, Department.SALES, Department.FINANCE)),
