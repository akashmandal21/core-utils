...
public enum PoStatus {
    ...
    TH_SHORT_CLOSE_PENDING("Transformation Head Short Close Pending", 1, Arrays.asList(Department.DESIGN, Department.PROCUREMENT, Department.GC, Department.TRANSFORMATIONS)),
    TH_SHORT_CLOSED("Short Closed By Transformation Head", -1, Arrays.asList(Department.DESIGN, Department.PROCUREMENT, Department.GC, Department.TRANSFORMATIONS)),
    ...
    SALES_CT_SHORT_CLOSE_PENDING("Sales Central Team Short Close Pending", 1, Arrays.asList(Department.SALES)),
    SALES_CT_SHORT_CLOSED("Short Closed By Sales Central Team", -1, Arrays.asList(Department.SALES)),
