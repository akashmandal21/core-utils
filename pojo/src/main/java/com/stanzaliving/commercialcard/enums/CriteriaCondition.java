...
public enum CriteriaCondition {
    ...
    // only for rule engine. Don't use it in code anywhere venta side
    EQUALS("==", "EQUALS", "Equals "),
    GREATER_THAN_EQUAL("<=", "GREATER_THAN_EQUAL","Is greater than equal "),
    LESS_THAN_EQUAL(">=", "LESS_THAN_EQUAL" , "Is less than equal "),
    NOT_EQUAL("!=", "NOT_EQUAL", "Is not equal"),
    IN(".contains", "IN", "in");
