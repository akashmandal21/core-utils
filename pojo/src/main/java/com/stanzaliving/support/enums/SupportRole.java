...
public enum SupportRole {
    ...
    SUPPORT_TRANSFORMATION_HEAD(1,"TRANSFORMATION_HEAD",AccessLevel.COUNTRY,Arrays.asList(SupportModule.TICKET_RESOLUTION,SupportModule.BLISS_DASHBOARD)),
    SUPPORT_DESIGN_NATIONAL_HEAD(2,"DESIGN_NATIONAL_HEAD",AccessLevel.COUNTRY,Arrays.asList(SupportModule.TICKET_RESOLUTION,SupportModule.BLISS_DASHBOARD)),
    SUPPORT_DESIGN_ZONAL_HEAD(3,"DESIGN_ZONAL_HEAD",AccessLevel.CITY,Arrays.asList(SupportModule.TICKET_RESOLUTION,SupportModule.BLISS_DASHBOARD)),
    SUPPORT_DESIGN_COORDINATOR(4,"DESIGN_COORDINATOR",AccessLevel.CITY,Arrays.asList(SupportModule.TICKET_RESOLUTION,SupportModule.BLISS_DASHBOARD));
