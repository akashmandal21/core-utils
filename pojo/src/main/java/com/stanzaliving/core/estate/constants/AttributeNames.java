...
public class AttributeNames {	
	...
	public static final String POC_NAME = "pocNumber";

	public static final String ROOM_TYPE = "roomType";
	public static final String ROOM_COUNT = "roomCount";

	public static final String TERRACE_ACCESSIBLE = "terraceAccess";

	public static final String NUMBER_OF_FLOORS = "floorCount";

	public static final String STILT_AVAILABLE = "stilt";
	...
	public static final String WATER_STORAGE_AVAILABLE = "waterStorageAvailable";
	...
	public static final String BASEMENT_AVAILABLE = "basementAvailable";
