...
public enum BDDashboardStatus {
	...
	UNDER_DRAFT("Under Draft", Arrays.asList(EstateStatus.DRAFT_IN_PROGRESS,EstateStatus.APPROVED_BY_CITY_HEAD,EstateStatus.SENT_BACK,EstateStatus.SENT_BACK_BY_CITY_HEAD,EstateStatus.SENT_BACK_BY_LEADERSHIP,EstateStatus.SENT_BACK_BY_TRANSFORMATION,EstateStatus.SENT_BACK_BY_LEGAL,EstateStatus.SENT_BACK_BY_CENTRAL_BD_TEAM),"#990199"),
	PENDING_ANDY_APPROVAL("Pending Andy Approval", Arrays.asList(EstateStatus.SIGNED_ATL_UPLOADED),"#000000"),
	REJECTED("Rejected", Arrays.asList(EstateStatus.REJECTED),"#DC3913"),
	PENDING_RM_APPROVAL("Pending RM Approval", Arrays.asList(EstateStatus.SENT_FOR_APPROVAL_TO_CITY_HEAD),"#FF9902"),
	PENDING_NATIONAL_HEAD_APPROVAL("Pending National Head Approval", Arrays.asList(EstateStatus.SENT_FOR_APPROVAL,EstateStatus.APPROVED_BY_TRANSFORMATION),"#3366CC"),
