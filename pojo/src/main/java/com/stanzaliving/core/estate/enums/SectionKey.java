...
public enum SectionKey {
	...
	ROOMS_WITH_AC_REQUIREMENT("Rooms with AC requirement","roomsWithAcRequirement", TemplateParentKey.OTHERS, Boolean.TRUE, Boolean.TRUE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
	ROOMS_WITH_TV_REQUIREMENT("Rooms with TV requirement","roomsWithTvRequirement", TemplateParentKey.OTHERS, Boolean.TRUE, Boolean.TRUE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
