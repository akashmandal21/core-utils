...
public enum SectionKey {
	...
	BREAKFAST("Breakfast","breakfast", TemplateParentKey.OTHERS, Boolean.FALSE, Boolean.FALSE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE)),
	LUNCH("Lunch", "lunch", TemplateParentKey.OTHERS,Boolean.FALSE,Boolean.FALSE,Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IS_AVAILABLE,IMAGE)),
	SNACKS("Snacks","snacks", TemplateParentKey.OTHERS, Boolean.FALSE, Boolean.FALSE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE)),
	DINNER("Dinner","dinner", TemplateParentKey.OTHERS, Boolean.FALSE, Boolean.FALSE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE)),
	BEVERAGES("Beverages (tea + coffee + milk)","beverages", TemplateParentKey.OTHERS, Boolean.FALSE, Boolean.FALSE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE)),
	...
	CHICKEN("Chicken","chicken", TemplateParentKey.OTHERS, Boolean.FALSE, Boolean.FALSE, Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
