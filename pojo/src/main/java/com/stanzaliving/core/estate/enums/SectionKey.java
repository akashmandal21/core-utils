...
public enum SectionKey {
	...
	LUNCH("Lunch", "lunch", TemplateParentKey.OTHERS,Boolean.TRUE,Boolean.TRUE,Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
	...
	DESSERT("Dessert", "dessertAvailable", TemplateParentKey.OTHERS,Boolean.TRUE,Boolean.TRUE,Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
	EGGS("Eggs", "eggsAvailable", TemplateParentKey.OTHERS,Boolean.TRUE,Boolean.TRUE,Arrays.asList(SELECTED_OPTIONS,REMARKS,INPUT_VALUE,IMAGE)),
