...
public enum LeadSourceEnum {
    ...
    BLOG_WEB_CHATBOT("Blog Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    CONTACT_US_WEB_CHATBOT("Contact Us Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    COOKIE_POLICY_PAGE("Cookie Policy Page", LeadSourceGroupEnum.DIGITAL),
    COOKIE_POLICY_WEB_CHATBOT("Cookie Policy Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    COVID19_WEB_CHATBOT("Covid19 Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    FAQ_WEB_CHATBOT("Faq Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    FLAT_URL_WEB_CHATBOT("Flat Url Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    HOME_WEB_CHATBOT("Home Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    HOTSTAR("Hotstar", LeadSourceGroupEnum.DIGITAL),
    HOUSE_RULES_PAGE("House rules page", LeadSourceGroupEnum.DIGITAL),
    HOUSE_RULES_WEB_CHATBOT("House Rules Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    INVESTORS_WEB_CHATBOT("Investors Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    LISTING_WEB_CHATBOT("Listing Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    MEDIA_WEB_CHATBOT("Media Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    PARTNER_WEB_CHATBOT("Partner Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    PBREFUND_WEB_CHATBOT("Prebooking Refund Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    PRIVACY_POLICY_WEB_CHATBOT("Privacy Policy Web Chatbot", LeadSourceGroupEnum.DIGITAL),
    ...
    REFER_WEB_CHATBOT("Refer Web Chatbot", LeadSourceGroupEnum.DIGITAL),
