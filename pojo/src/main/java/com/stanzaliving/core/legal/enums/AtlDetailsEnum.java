...
public enum AtlDetailsEnum {
    ...
    WATER_SUPPLY_CLAUSE_A_TEXT_AREA("Water", "(Lease Term)", AttributeNames.WATER_SUPPLY_CLAUSE_A_TEXT_AREA, AttributeNames.CONNECTED_WATER_SUPPLY_REMARKS, "Connected water supply from the municipal corporation to be provided for the building, with all municipal clearances and functional water meters"),
    WATER_SUPPLY_CLAUSE_B_TEXT_AREA("Water", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_B_TEXT_AREA, AttributeNames.FULLY_FUNCTIONAL_WATER_PUMPS_REMARKS, "Fully functional water pumps with full working AMC. If the current system does not have AMC, then one-time cost required for a new AMC to be borne by Lessor"),
    WATER_SUPPLY_CLAUSE_C_TEXT_AREA("Water", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_C_TEXT_AREA, AttributeNames.AUTOMATION_OF_WATER_STORAGE_REMARKS, "Automation of water storage and pumping system with full working AMC. If no running AMC is present, then one-time cost required for new AMC to be borne by Lessor"),
    WATER_SUPPLY_CLAUSE_D_TEXT_AREA("Water", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_D_TEXT_AREA, AttributeNames.BASEMENT_OTHER_AREAS_MAY_REMARKS, "Basement/other areas may be susceptible to ingress of water - a sump to pump out water must be installed with working AMC. If no running AMC, then one-time cost to be borne by Lessor"),
    WATER_SUPPLY_CLAUSE_E_TEXT_AREA("Water", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_E_TEXT_AREA, AttributeNames.WATER_SUPPLY_BOREWELL_REMARKS, "Providing Borewells (number as provided hereinabove) with appropriate water levels maintained"),

    WATER_STORAGE_CLAUSE_A_TEXT_AREA("Water", "(One Time)", AttributeNames.WATER_STORAGE_CLAUSE_A_TEXT_AREA, AttributeNames.WATER_TANK_CAPACITY_TO_BE_CALCULATED_REMARKS, "Water tank capacity to be calculated at 200Litres/bed for both the OHT and underground tank. All OHT plumbing tanks need to be connected"),
    ...
    FACADE_CLAUSE_B_TEXT_AREA("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_B_TEXT_AREA, AttributeNames.EXTERNAL_DOOR_WINDOWS_REMARKS, "External door/windows - All external door and windows to be checked for faults and repaired. Faults include but are not limited to:"),
    FACADE_CLAUSE_B_TEXT_AREA_1("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_B_TEXT_AREA_1, AttributeNames.EXTERNAL_DOOR_WINDOWS_REMARKS, "1. Defective hinges - these need to be replaced with functioning ones"),
    FACADE_CLAUSE_B_TEXT_AREA_2("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_B_TEXT_AREA_2, AttributeNames.EXTERNAL_DOOR_WINDOWS_REMARKS, "2. Cracked or broken shutters or mosquito nets need to be repaired/replaced keeping the same finishes as the existing shutters"),
    FACADE_CLAUSE_B_TEXT_AREA_3("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_B_TEXT_AREA_3, AttributeNames.EXTERNAL_DOOR_WINDOWS_REMARKS, "3. In sliding windows - the channel to allow for easy movement and a functional drain hole"),


    TERRACE_AREA_CLAUSE_A_TEXT_AREA("Terrace", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_A_TEXT_AREA, AttributeNames.WEATHER_PROOF_ROOF_REMARKS, "In case terrace level is being used for common areas or dining, weatherproof roof to be provided (steel truss with closed system and insulated metal sheeting, waterproof cladding.). Lessor to provide wall closure (aluminum framing with glass infill) to make room weatherproof."),
    TERRACE_AREA_CLAUSE_B_TEXT_AREA("Terrace", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_B_TEXT_AREA, AttributeNames.USABLE_TERRACE_REMARKS, "All required plumbing tap-offs and electrical connections for the usable terrace, basement, stilt floor to be provided to the satisfaction of the Lessee."),
    TERRACE_AREA_CLAUSE_C_TEXT_AREA("Terrace", "(Lease Term)", AttributeNames.TERRACE_AREA_CLAUSE_C_TEXT_AREA, AttributeNames.FINISHED_FLOORING_REMARKS, "Finished flooring to be provided in either stone or tile at terrace, basement, ground level if the level is usable, to the satisfaction of the Lessee."),
    TERRACE_AREA_CLAUSE_D_TEXT_AREA("Terrace", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_D_TEXT_AREA, AttributeNames.LL_FUNCTIONAL_TOILETS_REMARKS, "LL to provide functional toilets at terrace, basement, ground level if the level is usable. Any sewage in the basements to the be pumped via sump."),
    TERRACE_AREA_CLAUSE_E_TEXT_AREA("Terrace", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_E_TEXT_AREA, AttributeNames.LL_TOILETS_AT_TERRACE_REMARKS, "Protective railing up to 5 feet from FFL on terrace is required. Bamboo and MS are acceptable"),
    TERRACE_AREA_CLAUSE_F_TEXT_AREA("Terrace", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_F_TEXT_AREA, AttributeNames.LL_EXTERIOR_FACADE_REMARKS, "LL to close the exterior facade of the building (typical floors, stilt levels and terrace levels), to the satisfaction of the Lessee as specified in the design scheme"),

    OCCUPIED_LEVELS_CLAUSE_A_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_A_TEXT_AREA, AttributeNames.ENTIRE_INTERIOR_SPACE_REMARKS, "The entire interior space (rooms, corridors, common areas) to be painted as per Lessee specifications, specified in the design manual<br/>Berger Paint Codes for <strong>Corridors & Staircase</strong>Texture Paint - Tree Shade | Texture-Ruff N Tuff (Scratch Fine) 8T 0346 | With Texture Wall<br/>Berger Paint Code for <strong>Common Areas</strong>Wall Paint - Show Steeler | 8T 2694 | Without Texture<br/><strong>Ceiling Paint</strong><br/>Berger - White Swan 2P 1847"),
    OCCUPIED_LEVELS_CLAUSE_B_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_B_TEXT_AREA, AttributeNames.ANY_CRACKS_IN_THE_WALLS_REMARKS, "Any cracks in the walls/ plaster in the interior spaces to be repaired and repainted"),
    OCCUPIED_LEVELS_CLAUSE_C_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_C_TEXT_AREA, AttributeNames.GENERAL_LIGHTING_REMARKS, "General Lighting to be provided for corridors, common areas, etc as per the requirements of the Lessee specified in the design manual"),
    OCCUPIED_LEVELS_CLAUSE_D_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_D_TEXT_AREA, AttributeNames.DINING_SPACE_REMARKS, "Dining space is to be provided for students. It must have the capacity to seat a minimum of 30% of the number of beds. A minimum of 10-15 sq. ft. per person must be considered for this. The associated kitchen to be approx. 20% of dining space, with a min. area of 120 sq. ft."),
    OCCUPIED_LEVELS_CLAUSE_E_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_E_TEXT_AREA, AttributeNames.ALL_FLOORING_FOR_COMMON_AREAS_REMARKS, "In case the stilt, terrace or basement is being used for common areas or dining, all flooring (tiles/stone of approved spec), electrical connections and general lighting must be provided for"),
    OCCUPIED_LEVELS_CLAUSE_F_TEXT_AREA("Occupied", "(One Time)", AttributeNames.OCCUPIED_LEVELS_CLAUSE_F_TEXT_AREA, AttributeNames.ALL_FLOORING_FOR_KITCHEN_REMARKS, "All kitchen/utensil wash/pantry areas to have hard flooring as per lessee’s specs."),
    ...
    ELECTRICAL_CLAUSE_D_TEXT_AREA("Electrical", "(One Time)", AttributeNames.ELECTRICAL_CLAUSE_D_TEXT_AREA, AttributeNames.SUFFICIENT_CONNECTED_LOAD_CATERING_REMARKS, "Sufficient connected load catering to 100% occupancy (load requirement to be provided) and power factor correction as per existing load requirements. Overall load calculation of a building for"),
    ELECTRICAL_CLAUSE_D_TEXT_AREA_1("Electrical", "(One Time)", AttributeNames.ELECTRICAL_CLAUSE_D_TEXT_AREA_1, AttributeNames.SUFFICIENT_CONNECTED_LOAD_CATERING_REMARKS, "- Non-AC buildings: 90% rooms to be @ .45kW + 10% rooms to be @ 1.5kW"),
    ELECTRICAL_CLAUSE_D_TEXT_AREA_2("Electrical", "(One Time)", AttributeNames.ELECTRICAL_CLAUSE_D_TEXT_AREA_2, AttributeNames.SUFFICIENT_CONNECTED_LOAD_CATERING_REMARKS, "- Air-conditioned buildings: 100% rooms @ 1.5kW"),
    ...
    DOCS_AND_A_M_C_CLAUSE_A_TEXT_AREA("Docs", "(One Time)", AttributeNames.DOCS_AND_A_M_C_CLAUSE_A_TEXT_AREA, AttributeNames.ALL_TEST_CERTIFICATE_AND_DOCUMENTS, "All test certificate and Documents / Warranty certificate /manual of all equipment need to be provided by the Lessor. System to be tested with Lessee engineer before handing over to Lessee"),
    COMMON_AREAS_CLAUSE_A_TEXT_AREA("Common", "(Lease Term)", AttributeNames.COMMON_AREAS_CLAUSE_A_TEXT_AREA, AttributeNames.LIGHTING_AND_POWER_TO_BE_INSTALLED_REMARKS, "If common areas shared by Lessor & Lessee, the lighting & power to be installed & maintained by Lessor");
