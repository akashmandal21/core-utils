...
public enum AtlDetailsEnum {
    ...
    ROOM_CLAUSE_A_TEXT_AREA("Room", "(One Time)", AttributeNames.ROOM_CLAUSE_A_TEXT_AREA, AttributeNames.ALL_BROKEN_CRACKED_FURNITURE_REMARKS, "All broken/ cracked furniture to be repaired (woodwork, metalwork & hardware, laminates) and provide keys to almirahs locks if applicable."),
    ROOM_CLAUSE_B_TEXT_AREA("Room", "(One Time)", AttributeNames.ROOM_CLAUSE_B_TEXT_AREA, AttributeNames.KEYS_TO_LOCKS_OF_DOORS_REMARKS, "All keys to locks of doors must be unique and handed over with 3 key sets."),
