...
public enum AtlDetailsEnum {
    ...
    WATER_SUPPLY_CLAUSE_A_TEXT_AREA("Water Supply", "(Lease Term)", AttributeNames.WATER_SUPPLY_CLAUSE_A_TEXT_AREA, AttributeNames.CONNECTED_WATER_SUPPLY_REMARKS, "inter-connected water supply from the municipal corporation to be provided for the building, with all municipal clearances and functional water meters"),
    WATER_SUPPLY_CLAUSE_B_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_B_TEXT_AREA, AttributeNames.FULLY_FUNCTIONAL_WATER_PUMPS_REMARKS, "Fully functional water pumps with full working AMC. If the current system does not have AMC, then one-time maintenance cost required for a new AMC to be borne by Lessor"),
    WATER_SUPPLY_CLAUSE_C_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_C_TEXT_AREA, AttributeNames.AUTOMATION_OF_WATER_STORAGE_REMARKS, "Automation of water storage and pumping system with full working AMC. If no running AMC is present, then one-time maintenance cost required for new AMC to be borne by Lessor"),
    WATER_SUPPLY_CLAUSE_D_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_D_TEXT_AREA, AttributeNames.BASEMENT_OTHER_AREAS_MAY_REMARKS, "Basement/other areas may be susceptible to ingress of water - a sump to pump out water must be installed with working AMC. If no running AMC, then one-time maintenance cost to be borne by Lessor"),
    ...
    TERRACE_AREA_CLAUSE_E_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_E_TEXT_AREA, AttributeNames.LL_TOILETS_AT_TERRACE_REMARKS, "The associated kitchen area (enclosed space) to be additionally provided with an area of between 150 sq. ft. to 300 sq. ft basis the number of beds in the property. The size of the kitchen to be as per the Lessee's satisfaction."),
