...
public enum AtlDetailsEnum {
    ...
    STRUCTURE_CLAUSE_A_TEXT_AREA("Structure", "(Lease Term)", AttributeNames.STRUCTURE_CLAUSE_A_TEXT_AREA, AttributeNames.STRUCTURE_REMARKS, "Implementing any amendment based on the structural integrity check carried out by the Lessee."),

    FIRE_CLAUSE_A_TEXT_AREA("Fire", "(Lease Term)", AttributeNames.FIRE_CLAUSE_A_TEXT_AREA, AttributeNames.FIRE_COMPLIANCE_REMARKS, "Provide Fire NOC/Certificate, as applicable."),
    FIRE_CLAUSE_B_TEXT_AREA("Fire", "(One Time)", AttributeNames.FIRE_CLAUSE_B_TEXT_AREA, AttributeNames.FIRE_DEVICES_SUPPLY_INSTALLATION_TESTING_REMARKS,
            "Supply, Installation, Testing & Commissioning of the Fire Fighting System /equipment:</br>" +
                    ...
                    "iv. Emergency Exit & Fire Escape Staircase. (BH >15 mts)"),
    FIRE_CLAUSE_C_TEXT_AREA("Fire", "(Lease Term)", AttributeNames.FIRE_CLAUSE_C_TEXT_AREA, AttributeNames.FIRE_CLAUSE_C_REMARKS, "Any Periodical approvals (if any) to be obtained by Lessor."),
    FIRE_CLAUSE_D_TEXT_AREA("Fire", "(Lease Term)", AttributeNames.FIRE_CLAUSE_D_TEXT_AREA, AttributeNames.FIRE_CLAUSE_D_REMARKS, "Transfer working AMC or bear one-time cost for new AMC."),
    FIRE_CLAUSE_E_TEXT_AREA("Fire", "(One Time)", AttributeNames.FIRE_CLAUSE_E_TEXT_AREA, AttributeNames.FIRE_CLAUSE_E_REMARKS, "Provide Fire Extinguishers."),

    SEEPAGE_CLAUSE_A_TEXT_AREA("Seepage", "(Lease Term)", AttributeNames.SEEPAGE_CLAUSE_A_TEXT_AREA, AttributeNames.CORRECTION_OF_SEEPAGE_REMARKS, "Rectify Seepage arising out of plumbing pipes/faulty sanitaryware/ external wall seepage etc."),
    SEEPAGE_CLAUSE_B_TEXT_AREA("Seepage", "(Lease Term)", AttributeNames.SEEPAGE_CLAUSE_B_TEXT_AREA, AttributeNames.FIX_ISSUES_RELATED_TO_DRAINAGE_REMARKS, "Repair surface with proper painting/tiling as per Lessee’s satisfaction."),
    SEEPAGE_CLAUSE_C_TEXT_AREA("Seepage", "(Lease Term)", AttributeNames.SEEPAGE_CLAUSE_C_TEXT_AREA, AttributeNames.WATER_PROOFING_WORK_ON_TERRACE_REMARKS, "Waterproofing work on terrace, wet balcony, external surfaces and washroom with proper drainage and slopes."),
    SEEPAGE_CLAUSE_D_TEXT_AREA("Seepage", "(One Time)", AttributeNames.SEEPAGE_CLAUSE_D_TEXT_AREA, AttributeNames.SEEPAGE_CLAUSE_D_REMARKS, "Prevent and weather protect ingress of water from openings causing damage to  assets/infra, ensuring proper ventilation."),

    DRAINAGE_CLAUSE_A_TEXT_AREA("Drainage", "(One Time)", AttributeNames.DRAINAGE_CLAUSE_A_TEXT_AREA, AttributeNames.DRAINAGE_CLAUSE_A_REMARKS, "Provide sump to pump out water from basement/other areas. Transfer working AMC or bear one-time cost for new AMC."),

    WATER_SUPPLY_CLAUSE_A_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_A_TEXT_AREA, AttributeNames.CONNECTED_WATER_SUPPLY_REMARKS, "Provide water supply connection from the municipal authority with functional water meters, provide separate water meter in case of multiple tenants. Previous arrears to be cleared by Lessor before HO."),
    WATER_SUPPLY_CLAUSE_B_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_B_TEXT_AREA, AttributeNames.FULLY_FUNCTIONAL_WATER_PUMPS_REMARKS, "All water pumps/motors etc. to be safeguarded with metal cage(s) as per the specs provided by Lessee."),
    WATER_SUPPLY_CLAUSE_C_TEXT_AREA("Water Supply", "(One Time)", AttributeNames.WATER_SUPPLY_CLAUSE_C_TEXT_AREA, AttributeNames.AUTOMATION_OF_WATER_STORAGE_REMARKS, "Provide automated water storage and pumping system. Transfer working AMC or bear one-time cost for new AMC."),
    WATER_SUPPLY_CLAUSE_D_TEXT_AREA("Water Supply", "(Lease Term)", AttributeNames.WATER_SUPPLY_CLAUSE_D_TEXT_AREA, AttributeNames.BASEMENT_OTHER_AREAS_MAY_REMARKS, "In case the ground water quality is not potable/high TDS or there is inadequate discharge of water, share the cost of water purchased from the external source."),
    WATER_SUPPLY_CLAUSE_E_TEXT_AREA("Water Supply", "(Lease Term)", AttributeNames.WATER_SUPPLY_CLAUSE_E_TEXT_AREA, AttributeNames.WATER_SUPPLY_BOREWELL_REMARKS, "Provide Borewells (number as specified) with appropriate water levels."),
    ...
    WATER_STORAGE_CLAUSE_A_TEXT_AREA("Water Storage", "(One Time)", AttributeNames.WATER_STORAGE_CLAUSE_A_TEXT_AREA, AttributeNames.WATER_TANK_CAPACITY_TO_BE_CALCULATED_REMARKS, "Water tank capacity to be calculated at 200 Litres/bed. All over head tanks to be inter-connected. Please mention the total storage capacity of OH+UG tank."),
    WATER_STORAGE_CLAUSE_B_TEXT_AREA("Water Storage", "(One Time)", AttributeNames.WATER_STORAGE_CLAUSE_B_TEXT_AREA, AttributeNames.WATER_STORAGE_CLAUSE_B_REMARKS, "Water tanks to be cleaned before handover."),
    WATER_STORAGE_CLAUSE_C_TEXT_AREA("Water Storage", "(One Time)", AttributeNames.WATER_STORAGE_CLAUSE_C_TEXT_AREA, AttributeNames.WATER_STORAGE_CLAUSE_C_REMARKS, "Provide tanks with automated overflow alarm & starter for cut-off."),


    SITE_CLAUSE_A_TEXT_AREA("SITE", "(Lease Term)", AttributeNames.SITE_CLAUSE_A_TEXT_AREA, AttributeNames.SITE_CLAUSE_A_REMARKS, "Secure building/site from all sides and repair or gate any openings in the boundary walls."),
    SITE_CLAUSE_B_TEXT_AREA("SITE", "(Lease Term)", AttributeNames.SITE_CLAUSE_B_TEXT_AREA, AttributeNames.SITE_CLAUSE_B_REMARKS, "If the site is shared by other tenants, separate secure entrance and area to be provided to the Lessee."),
    SITE_CLAUSE_C_TEXT_AREA("SITE", "(One Time)", AttributeNames.SITE_CLAUSE_C_TEXT_AREA, AttributeNames.SITE_CLAUSE_C_REMARKS, "Provide basic cleaning and landscaping of the area around the property. Remove debris or scrap materials."),

    FACADE_CLAUSE_A_TEXT_AREA("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_A_TEXT_AREA, AttributeNames.ANY_MASONRY_PLASTER_CRACKS_REMARKS, "Any masonry/plaster cracks to be fixed and painted post fixing as per Lessee specified brand colours or the scheme shared by the Lessee."),
    FACADE_CLAUSE_B_TEXT_AREA("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_B_TEXT_AREA, AttributeNames.EXTERNAL_DOOR_WINDOWS_REMARKS, "External door/windows – Check and repair faults in external doors and windows. Faults include but are not limited to:" +
            ...
            "<li> Open shafts to be closed with safety net and to be made weatherproof.</li></ol>"),
    FACADE_CLAUSE_C_TEXT_AREA("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_C_TEXT_AREA, AttributeNames.EXTERIOR_FACADE_CLOSER_REMARKS, "Mosquito mesh / safety nets to be provided on all windows."),
    FACADE_CLAUSE_D_TEXT_AREA("Facade", "(One Time)", AttributeNames.FACADE_CLAUSE_D_TEXT_AREA, AttributeNames.FACADE_REPAINTING_REMARKS, "Lessor to paint the façade as per Lessee’s Specification.\n" +
            ...
            "<br/>-Asian Paints: Base Colour -  Grand Grape (Blue), Accent Colour – Eggshell (White), Dessert Glow (Yellow)"),

    COMMON_FACILITIES_CLAUSE_A("Common Facilities", "(One Time)", AttributeNames.COMMON_FLTY_CLAUSE_A_TEXT_AREA, AttributeNames.COMMON_FLTY_CLAUSE_A_REMARKS, "Provide secure entrance with doors or to be align for debit for work executed by the Lessee."),
    COMMON_FACILITIES_CLAUSE_B("Common Facilities", "(One Time)", AttributeNames.COMMON_FLTY_CLAUSE_B_TEXT_AREA, AttributeNames.COMMON_FLTY_CLAUSE_B_REMARKS, "Provide functional toilets at stilt or ground."),
    COMMON_FACILITIES_CLAUSE_C("Common Facilities", "(One Time)", AttributeNames.COMMON_FLTY_CLAUSE_C_TEXT_AREA, AttributeNames.COMMON_FLTY_CLAUSE_C_REMARKS, "Protective railing of min 1200 mm from FFL is required on terrace (Bamboo and MS are acceptable extensions)"),
    COMMON_FACILITIES_CLAUSE_D("Common Facilities", "(One Time)", AttributeNames.COMMON_FLTY_CLAUSE_D_TEXT_AREA, AttributeNames.COMMON_FLTY_CLAUSE_D_REMARKS, "Secure terrace with fence if it is accessible from adjacent blocks or if there is potential risk of loss of life or limb."),

    DINING_CLAUSE_A("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_A_TEXT_AREA, AttributeNames.DINING_CLAUSE_A_REMARKS, "Provide Dining space (enclosed, weather-proof and finished) with minimum space of 20 sq. ft/person for total bed count. Weatherproof roof and side walls/enclosures, tile/ stone flooring (cement flooring not acceptable) and adequate ventilation to be provided."),
    DINING_CLAUSE_B("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_B_TEXT_AREA, AttributeNames.DINING_CLAUSE_B_REMARKS, "Steel truss with closed system and insulated metal sheeting, waterproof cladding with one fan per 120 sq. ft and general lighting."),
    DINING_CLAUSE_C("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_C_TEXT_AREA, AttributeNames.DINING_CLAUSE_C_REMARKS, "Aluminium framing with glass infill on brick toe wall with adequate waterproofing to prevent ingress of water from the outside into the dining/common area and one operable window in every 10 ft grid. Detail to be picked from design manual."),
    ...
    DINING_CLAUSE_E("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_E_TEXT_AREA, AttributeNames.DINING_CLAUSE_E_REMARKS, "Brick/ block Masonry/weatherproof dry wall partition with operable windows (aluminium frame with infill glass)"),
    DINING_CLAUSE_F("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_F_TEXT_AREA, AttributeNames.DINING_CLAUSE_F_REMARKS, "All finished flooring (tiles/stone of approved spec), electrical connections, plumbing tap-offs, paint, general lighting must be provided to the satisfaction of the Lessee."),
    DINING_CLAUSE_G("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_G_TEXT_AREA, AttributeNames.DINING_CLAUSE_G_REMARKS, "Insulated metal sheeting with proper arrangement for water drainage."),
    DINING_CLAUSE_H("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_H_TEXT_AREA, AttributeNames.DINING_CLAUSE_H_REMARKS, "RCC roof with proper arrangement for water drainage."),
    DINING_CLAUSE_I("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_I_TEXT_AREA, AttributeNames.DINING_CLAUSE_I_REMARKS, "If the basement is large, ample light and ventilation to be provided. Ensure air changes are adequate."),
    DINING_CLAUSE_J("Dining", "(One Time)", AttributeNames.DINING_CLAUSE_J_TEXT_AREA, AttributeNames.DINING_CLAUSE_J_REMARKS, "Functional sump (with working sump pump) has to be present for kitchen sink and handwash."),


    KITCHEN_CLAUSE_A("Kitchen", "(One Time)", AttributeNames.KITCHEN_CLAUSE_A_TEXT_AREA, AttributeNames.KITCHEN_CLAUSE_A_REMARKS, "Kitchen area (enclosed space) to be additionally provided with an area of between 150 sq. ft. to 300 sq. ft or as per the Lessee's specification."),
    KITCHEN_CLAUSE_B("Kitchen", "(One Time)", AttributeNames.KITCHEN_CLAUSE_B_TEXT_AREA, AttributeNames.KITCHEN_CLAUSE_B_REMARKS, "Provide exhaust fan and lighting (LED tube light -18W-6000K)."),
    KITCHEN_CLAUSE_C("Kitchen", "(One Time)", AttributeNames.KITCHEN_CLAUSE_C_TEXT_AREA, AttributeNames.KITCHEN_CLAUSE_C_REMARKS, "All kitchen/utensil wash/pantry areas to have hard flooring as per the Lessee’s specification."),
    KITCHEN_CLAUSE_D("Kitchen", "(One Time)", AttributeNames.KITCHEN_CLAUSE_D_TEXT_AREA, AttributeNames.KITCHEN_CLAUSE_D_REMARKS, "All kitchen to have proper plumbing, drainage and electrical points as per Lessee's specification."),

    CIRCULATION_CLAUSE_A("Circulation Spaces", "(One Time)", AttributeNames.CIRCULATION_CLAUSE_A_TEXT_AREA, AttributeNames.CIRCULATION_CLAUSE_A_REMARKS, "The entire interior space of common area/ dining to be painted as per design manual or as specified by the Lessee."),
    CIRCULATION_CLAUSE_B("Circulation Spaces", "(One Time)", AttributeNames.CIRCULATION_CLAUSE_B_TEXT_AREA, AttributeNames.CIRCULATION_CLAUSE_B_REMARKS, "The entire interior space of corridors & staircases to be painted as per design manual or as specified by the Lessee."),
    CIRCULATION_CLAUSE_C("Circulation Spaces", "(One Time)", AttributeNames.CIRCULATION_CLAUSE_C_TEXT_AREA, AttributeNames.CIRCULATION_CLAUSE_C_REMARKS, "Any cracks in the interior spaces to be repaired and repainted"),
    CIRCULATION_CLAUSE_D("Circulation Spaces", "(One Time)", AttributeNames.CIRCULATION_CLAUSE_D_TEXT_AREA, AttributeNames.CIRCULATION_CLAUSE_D_REMARKS, "Lighting to be provided for corridors, common areas etc. as per the requirements & specs shared by the Lessee. (Bulbs are not acceptable)"),
    CIRCULATION_CLAUSE_E("Circulation Spaces", "(One Time)", AttributeNames.CIRCULATION_CLAUSE_E_TEXT_AREA, AttributeNames.CIRCULATION_CLAUSE_E_REMARKS, "Specification for corridor & common area:<br/>" +
            ...
            "For corridor & Staircase texture Paint – Tree shade| Texture-Ruff N Tuff (Scratch Fine) 8T 0346|With texture wall Berger Paint Code for Common Area Wall Paint – Show Steeler | 8T 2694 | Without texture Ceiling Paint Berger – White Swan 2P 1847"),


    TERRACE_AREA_CLAUSE_A_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_A_TEXT_AREA, AttributeNames.WEATHER_PROOF_ROOF_REMARKS, "In case terrace/stilt/basement level is being used for common areas or dining, weatherproof roof and side walls / enclosures to be provided (steel truss with closed system and insulated metal sheeting, waterproof cladding.). Lessor to provide wall closure (aluminum framing with glass infill or any other material acceptable to the Lessee) to make area weatherproof."),
    TERRACE_AREA_CLAUSE_B_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_B_TEXT_AREA, AttributeNames.USABLE_TERRACE_REMARKS, "In case the stilt, terrace or basement is being used for common areas or dining, all finished flooring (tiles/stone of approved spec), electrical connections, plumbing tap-offs and general lighting must be provided to the satisfaction of the Lessee"),
    TERRACE_AREA_CLAUSE_C_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(Lease Term)", AttributeNames.TERRACE_AREA_CLAUSE_C_TEXT_AREA, AttributeNames.FINISHED_FLOORING_REMARKS, "LL to provide functional toilets at terrace, basement, stilt or ground level if the level is usable. Any sewage in the basements to the ground floor should be pumped via sump."),
    TERRACE_AREA_CLAUSE_D_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_D_TEXT_AREA, AttributeNames.LL_FUNCTIONAL_TOILETS_REMARKS, "Dining space (enclosed and weather-proof) is to be provided for residents. It must have the capacity to seat a minimum of 30% of the number of beds. A minimum of 10-15 sq. ft. per person must be considered for this."),
    TERRACE_AREA_CLAUSE_E_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_E_TEXT_AREA, AttributeNames.FFL_ON_TERRACE_REMARKS, "The associated kitchen area (enclosed space) to be additionally provided with an area of between 150 sq. ft. to 300 sq. ft basis the number of beds in the property. The size of the kitchen to be as per the Lessee's satisfaction."),
    TERRACE_AREA_CLAUSE_F_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_F_TEXT_AREA, AttributeNames.LL_EXTERIOR_FACADE_REMARKS, "All kitchen/utensil wash/pantry areas to have hard flooring as per the Lessee’s specs."),
    TERRACE_AREA_CLAUSE_G_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_G_TEXT_AREA, AttributeNames.PROTECTIVE_RAILING_REMARKS, "Protective railing up to 5 feet from FFL on terrace is required. Bamboo and MS are acceptable."),
    TERRACE_AREA_CLAUSE_H_TEXT_AREA("STILT / TERRACE / BASEMENT LEVEL", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_H_TEXT_AREA, AttributeNames.EXTERIOR_FACADE_REMARKS, "LL to close the exterior facade of the building (typical floors, stilt levels and terrace levels), to the satisfaction of the Lessee as specified in the design scheme"),
    ...
    ROOM_CLAUSE_A_TEXT_AREA("Rooms", "(One Time)", AttributeNames.ROOM_CLAUSE_A_TEXT_AREA, AttributeNames.ALL_BROKEN_CRACKED_FURNITURE_REMARKS, "Lessor’s furniture to be repaired (woodwork, metalwork & hardware, lamination) or Lessee to repair and debit from Lessor."),
    ROOM_CLAUSE_B_TEXT_AREA("Rooms", "(One Time)", AttributeNames.ROOM_CLAUSE_B_TEXT_AREA, AttributeNames.KEYS_TO_LOCKS_OF_DOORS_REMARKS, "For all Lessor’s almirahs and room doors, 3 unique keys must be provided or Lessee to arrange and debit from the Lessor."),
    ROOM_CLAUSE_C_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_C_TEXT_AREA, AttributeNames.LIVEABLE_ROOM_AREA_REMARKS, "Provide two lights of 12 W each per 120 sq. ft."),
    ROOM_CLAUSE_D_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_D_TEXT_AREA, AttributeNames.ROOM_INTERIORS_REMARKS, "The entire interior space (rooms, corridors, common areas) to be painted as per design manual or as specified by the Lessee."),

    ROOM_CLAUSE_F_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_F_TEXT_AREA, AttributeNames.CURTAIN_RODS_REMARKS, "Provide curtain rods."),
    ROOM_CLAUSE_G_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_G_TEXT_AREA, AttributeNames.ROOM_CLAUSE_G_REMARKS, "Provide 1 fan per 120 sq. ft (2 fans are mandatory above 120 sq. ft)"),
    ROOM_CLAUSE_H_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_H_TEXT_AREA, AttributeNames.ROOM_CLAUSE_H_REMARKS, "Provide one 6 Amp point per bed and one 16 Amp point per room."),
    ROOM_CLAUSE_I_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_I_TEXT_AREA, AttributeNames.ROOM_CLAUSE_I_REMARKS, "Provide Cloth hooks."),
    ROOM_CLAUSE_J_TEXT_AREA("Room infra", "(One Time)", AttributeNames.ROOM_CLAUSE_J_TEXT_AREA, AttributeNames.ROOM_CLAUSE_J_REMARKS, "Provide Room mirrors."),

    ROOM_CLAUSE_E_TEXT_AREA("Bathroom", "(One Time)", AttributeNames.ROOM_CLAUSE_E_TEXT_AREA, AttributeNames.BATHROOM_ACCESSORIES_REMARKS, "Provide washbasin and bathroom mirrors."),
    ROOM_CLAUSE_K_TEXT_AREA("Bathroom", "(One Time)", AttributeNames.ROOM_CLAUSE_K_TEXT_AREA, AttributeNames.ROOM_CLAUSE_K_REMARKS, "Provide showers."),
    ROOM_CLAUSE_L_TEXT_AREA("Bathroom", "(One Time)", AttributeNames.ROOM_CLAUSE_L_TEXT_AREA, AttributeNames.ROOM_CLAUSE_L_REMARKS, "Provide WC with Health faucet."),
    ROOM_CLAUSE_M_TEXT_AREA("Bathroom", "(One Time)", AttributeNames.ROOM_CLAUSE_M_TEXT_AREA, AttributeNames.ROOM_CLAUSE_M_REMARKS, "Provide Min one light in toilet (LED-5W-8W)."),
    ...
    SANITARY_CLAUSE_C_TEXT_AREA("Sanitary", "(Lease Term)", AttributeNames.SANITARY_CLAUSE_C_TEXT_AREA, AttributeNames.REPLACEMENT_OF_BROKEN_DAMAGED_SANITARY_WARE_REMARKS, "Replacement of broken/damaged sanitary ware before handover including replacement of all Indian WCs (if any) with western WCs."),
    ...
    SANITARY_CLAUSE_E_TEXT_AREA("Sanitary", "(One Time)", AttributeNames.SANITARY_CLAUSE_E_TEXT_AREA, AttributeNames.LESSEE_SEWER_LINE_REMARKS, "Lessor need to connect Lessee sewer line to municipal sewer line"),


    WHITE_GOODS_CLAUSE_A_TEXT_AREA("White Goods", "(One Time)", AttributeNames.WHITE_GOODS_CLAUSE_A_TEXT_AREA, AttributeNames.FUNCTIONING_A_C_REMOTES_REMARKS, "Functioning AC remotes & stabilizer to be provided with all ACs"),
    ...
    ELECTRICAL_CLAUSE_D_TEXT_AREA("Electrical", "(One Time)", AttributeNames.ELECTRICAL_CLAUSE_D_TEXT_AREA, AttributeNames.SUFFICIENT_CONNECTED_LOAD_CATERING_REMARKS, "Load catering to 100% occupancy (load requirement to be provided) and power factor correction as per existing load requirements to be provided based on below calculation:" +
            ...
            "</br>Liaising under Lessor’s scope. Power sanction to be in the name of Lessor. CEIG approvals for all equipment to be taken by Lessor."),
    ELECTRICAL_CLAUSE_B_TEXT_AREA("Electrical", "(Lease Term)", AttributeNames.ELECTRICAL_CLAUSE_B_TEXT_AREA, AttributeNames.WORK_ON_THE_H_T_SIDE_REMARKS, "Work on the HT side incl. transformers, servo stabilizer, metering and isolator panel, main panel with fire suppression system. Provision of 3-phase electrical line, earthing as per requirements of the Lessee."),
    ...
    POWER_BACKUP_CLAUSE_A_TEXT_AREA("Power Backup", "(Lease Term)", AttributeNames.POWER_BACKUP_CLAUSE_A_TEXT_AREA, AttributeNames.DIESEL_GENERATOR_WITH_AUTO_CHANGE_REMARKS, "Diesel Generator with auto changeover facility. Transfer working AMC or bear one-time cost for new AMC."),
    POWER_BACKUP_CLAUSE_B_TEXT_AREA("Power Backup", "(Lease Term)", AttributeNames.POWER_BACKUP_CLAUSE_B_TEXT_AREA, AttributeNames.REPLACEMENT_OF_D_G_REMARKS, "Provide 0.4KW inverter capacity per room with end-to-end wiring. Mention total backup load."),
    POWER_BACKUP_CLAUSE_C_TEXT_AREA("Power Backup", "(One Time)", AttributeNames.POWER_BACKUP_CLAUSE_C_TEXT_AREA, AttributeNames._N_O_C_P_U_C_LICENSE_FROM_LOCAL_AUTHORITY_REMARKS, "NOC/PUC license from local authority for DG. All fire safety norms and arrangements to be maintained. In cases where DG is kept within an enclosed space, there should be adequate ventilation away from living space."),
    POWER_BACKUP_CLAUSE_D_TEXT_AREA("Power Backup", "(Lease Term)", AttributeNames.POWER_BACKUP_CLAUSE_D_TEXT_AREA, AttributeNames.POWER_BACK_UP_WIRING_REMARKS, "Provide 0.4KW DG capacity per room with end-to-end wiring. Mention total DG capacity."),

    LIFT_CLAUSE_A_TEXT_AREA("Lift", "(One Time)", AttributeNames.LIFT_CLAUSE_A_TEXT_AREA, AttributeNames.LIFT_ONE_TIME_REFURBISHMENT_REMARKS, "One-time refurbishment (interiors, motor, etc.) by OEM to be done before handing over the lift. If the lift is unusable, Lessor to replace."),
    LIFT_CLAUSE_B_TEXT_AREA("Lift", "(One Time)", AttributeNames.LIFT_CLAUSE_B_TEXT_AREA, AttributeNames.AUTO_RESCUE_DEVICE_REMARKS, "Auto Rescue Device in working condition to be installed."),
    LIFT_CLAUSE_C_TEXT_AREA("Lift", "(One Time)", AttributeNames.LIFT_CLAUSE_C_TEXT_AREA, AttributeNames.WORKING_LIFT_A_M_C_REMARKS, "Provided working AMC for Lifts or bear one-time cost for new AMC."),
    LIFT_CLAUSE_D_TEXT_AREA("Lift", "(Lease Term)", AttributeNames.LIFT_CLAUSE_D_TEXT_AREA, AttributeNames.REPLACEMENT_OF_LIFT_REMARKS, "Lessor to ensure all lifts have proper operational panel, lights and flooring to the satisfaction of the Lessee."),
    ...
    EQUIPMENT_CLAUSE_A("Equipment", "(One Time)", AttributeNames.EQUIPMENT_CLAUSE_A_TEXT_AREA, AttributeNames.EQUIPMENT_CLAUSE_A_REMARKS, "Storage geyser (15 lts) or instant geyser (3 lts) of Age < 4 years old." +
            "</br>Minimum 1 per toilet."),
    EQUIPMENT_CLAUSE_B("Equipment", "(One Time)", AttributeNames.EQUIPMENT_CLAUSE_B_TEXT_AREA, AttributeNames.EQUIPMENT_CLAUSE_B_REMARKS, "Electric/Solar boiler of capacity > 25 lts/bed; (Wood fired boiler not allowed). Mention total hot water storage capacity."),
    EQUIPMENT_CLAUSE_C("Washing machine", "(One Time)", AttributeNames.EQUIPMENT_CLAUSE_C_TEXT_AREA, AttributeNames.EQUIPMENT_CLAUSE_C_REMARKS, "A covered space with plumbing and drainage points to be provided as specified by Lessee."),
    EQUIPMENT_CLAUSE_D("AC", "(One Time)", AttributeNames.EQUIPMENT_CLAUSE_D_TEXT_AREA, AttributeNames.EQUIPMENT_CLAUSE_D_REMARKS, "Functioning AC remotes & stabilizer to be provided for all ACs."),
    EQUIPMENT_CLAUSE_E("AC", "(One Time)", AttributeNames.EQUIPMENT_CLAUSE_E_TEXT_AREA, AttributeNames.EQUIPMENT_CLAUSE_E_REMARKS, "AC drainage & connection to outdoor units in case of split ACs to be planned & provided."),

    DOCS_AND_A_M_C_CLAUSE_A_TEXT_AREA("Docs And AMC", "(One Time)", AttributeNames.DOCS_AND_A_M_C_CLAUSE_A_TEXT_AREA, AttributeNames.ALL_TEST_CERTIFICATE_AND_DOCUMENTS, "All test certificates and Documents / Warranty certificate /manual of all equipment to be provided by the Lessor. System to be tested with Lessee’s designated engineer before handover."),

    ASSET_CLASE_A("Life Of Asset","(Lease Term)", AttributeNames.ASSET_CLAUSE_A_TEXT_AREA, AttributeNames.ASSET_CLAUSE_A_REMARKS, "White goods like AC, Geyser, Solar panel, Solar heater, Lifts, DG, Inverter and batteries, water pump, sump, washing machine, RO, Fridge, Microwave, TV, Furniture, lights, fans and other electrical infrastructure etc. to be repaired/replaced by the Lessor at the end of usable life or to be taken on rent by Lessee and debited from Lessor."),
