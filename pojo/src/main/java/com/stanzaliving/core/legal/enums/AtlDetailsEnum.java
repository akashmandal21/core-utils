...
public enum AtlDetailsEnum {
    ...
    TERRACE_AREA_CLAUSE_F_TEXT_AREA("Terrace Level", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_F_TEXT_AREA, AttributeNames.LL_EXTERIOR_FACADE_REMARKS, "All kitchen/utensil wash/pantry areas to have hard flooring as per the Lessee’s specs."),
    TERRACE_AREA_CLAUSE_G_TEXT_AREA("Terrace Level", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_G_TEXT_AREA, AttributeNames.PROTECTIVE_RAILING_REMARKS, "Protective railing up to 5 feet from FFL on terrace is required. Bamboo and MS are acceptable."),
    TERRACE_AREA_CLAUSE_H_TEXT_AREA("Terrace Level", "(One Time)", AttributeNames.TERRACE_AREA_CLAUSE_H_TEXT_AREA, AttributeNames.EXTERIOR_FACADE_REMARKS, "LL to close the exterior facade of the building (typical floors, stilt levels and terrace levels), to the satisfaction of the Lessee as specified in the design scheme"),
