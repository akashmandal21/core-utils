...
public enum GenericPOTOStatus {
    ...
    VENDOR_REJECTED("Rejected By Vendor", "#5FC4F5", "#EDF4FF", GenericConstants.rejectionStart - 4, false, false, null,false);
//    WORK_COMPLETED("Work Completed","#60C3AD","#60c3ad4d",7,false,false);
    ...
    static {
        ...
        approvals.addAll(Arrays.asList(CANCEL_L2_APPROVAL_DUE, CANCEL_L3_APPROVAL_DUE, SC_L2_APPROVAL_DUE, SC_L3_APPROVAL_DUE, L2_APPROVAL_DUE, L3_APPROVAL_DUE, APPROVED, SHORTCLOSED, CANCELLED, VENDOR_ACCEPTANCE_PENDING));
