...
//    WORK_COMPLETED("Work Completed","#60C3AD","#60c3ad4d",7,false,false);
    ...
    static {
        ...
        viewRole.addAll(Arrays.asList(CANCEL_L1_APPROVAL_DUE,CANCEL_L2_APPROVAL_DUE,CANCEL_L3_APPROVAL_DUE,SC_L1_APPROVAL_DUE,SC_L2_APPROVAL_DUE,SC_L3_APPROVAL_DUE,APPROVED,SHORTCLOSED,GSRI_COMPLETED));
