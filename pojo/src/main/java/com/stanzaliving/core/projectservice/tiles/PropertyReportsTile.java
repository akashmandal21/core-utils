...
public enum PropertyReportsTile {
    ...
    SFR("SFR",true,true,true,Department.PROJECTS,PropertyUpdateEnum.PROJECT_SFR_COMPLETED,"sfr-report"),
    //OFR("OFR",true,true),
    AS_IS("As-Is Report",true,true,true,Department.PROJECTS,PropertyUpdateEnum.PROJECT_AS_IS_COMPLETED,"asisdrawings"),
    GFC("GFC Drawings",true,true,true,Department.DESIGN,PropertyUpdateEnum.DESIGN_GFC_APPROVED,"gfcdrawings"),
    BOQ("Master BOQ Formation",true,true,true,Department.DESIGN,PropertyUpdateEnum.DESIGN_BOQ_COMPLETED,"boq"),
    ATL("ATL",true,true,true,null,null,""),
    BED_COUNT_FINALIZATION("Bed Count Finalization",true,false,true,Department.DESIGN,PropertyUpdateEnum.DESIGN_BED_COUNT_FINALIZATION_COMPLETED,"bedcount"),
    GC_SCHEDULE("GC Schedule",true,true,true,Department.GC,PropertyUpdateEnum.PROJECT_SITE_ENGINEER_ASSIGNED,"gc"),
    HOTO("Hoto",true,true,true,Department.PROJECTS,PropertyUpdateEnum.PROJECTS_HOTO_GENERATED,"hoto");
