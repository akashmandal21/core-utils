...
public enum Role {
    ...
    /************************************ ELECTRICITY ************************************/
	MICROMARKET_ELECTRICITY_SPLITTER_L1_APPROVER("MICROMARKET ELECTRICITY SPLITTER L1 APPROVER", AccessLevel.MICROMARKET, Department.OPS),
	CITY_ELECTRICITY_SPLITTER_L2_APPROVER("CITY ELECTRICITY SPLITTER L2 APPROVER", AccessLevel.CITY, Department.OPS),
	COUNTRY_ELECTRICITY_SPLITTER_L3_APPROVER("COUNTRY ELECTRICITY SPLITTER L3 APPROVER", AccessLevel.COUNTRY, Department.OPS),
