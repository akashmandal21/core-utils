...
public enum Role {
	...
	APARTMENT_RESIDENCE_LEAD_MANAGER("APARTMENT_RESIDENCE_LEAD_MANAGER", AccessLevel.RESIDENCE, Department.SALES),
	APARTMENT_MICROMARKET_LEAD_MANAGER("APARTMENT_MICROMARKET_LEAD_MANAGER", AccessLevel.MICROMARKET, Department.SALES),
	APARTMENT_CITY_LEAD_MANAGER("APARTMENT_CITY_LEAD_MANAGER", AccessLevel.CITY, Department.SALES),
	APARTMENT_ZONAL_LEAD_MANAGER("APARTMENT_ZONAL_LEAD_MANAGER", AccessLevel.CITY, Department.SALES),
	APARTMENT_COUNTRY_LEAD_MANAGER("APARTMENT_COUNTRY_LEAD_MANAGER", AccessLevel.COUNTRY, Department.SALES),
