...
public enum Role {
	...
	/* lead-service pg apartment role*/
    RESIDENCE_PG_APARTMENT_LEAD_MANAGER("RESIDENCE_PG_APARTMENT_LEAD_MANAGER", AccessLevel.RESIDENCE, Department.SALES),
	MICROMARKET_PG_APARTMENT_LEAD_MANAGER("MICROMARKET_PG_APARTMENT_LEAD_MANAGER", AccessLevel.MICROMARKET, Department.SALES),
	CITY_PG_APARTMENT_LEAD_MANAGER("CITY_PG_APARTMENT_LEAD_MANAGER", AccessLevel.CITY, Department.SALES),
	ZONAL_PG_APARTMENT_LEAD_MANAGER("ZONAL_PG_APARTMENT_LEAD_MANAGER", AccessLevel.CITY, Department.SALES),
	COUNTRY_PG_APARTMENT_LEAD_MANAGER("COUNTRY_PG_APARTMENT_LEAD_MANAGER", AccessLevel.COUNTRY, Department.SALES),
