...
import com.stanzaliving.core.bookingservice.dto.response.BookingDetailDto;
...
public class BookingDataControllerApi {
    ...
    public ResponseDto<List<BookingDetailDto>> getBookingDetailsForResident(String residentId) {
