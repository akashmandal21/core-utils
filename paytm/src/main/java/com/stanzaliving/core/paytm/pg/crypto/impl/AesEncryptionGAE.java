 ...
 */
@Log4j2
public class AesEncryptionGAE implements Encryption {
	...
	public String encrypt(String toEncrypt, String password) {
		...
		try {
			...
			log.error("Error while encrypting key using Google App Engine: ", e);
		}
	...
	public String decrypt(String toDecrypt, String key) {
		...
		try {
			...
			log.error("Error while decrypting key using Google App Engine: ", e);
		}
