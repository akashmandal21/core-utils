...
public class VentaAggregationServiceApi {
    ...
    public ResponseDto<List<ResidenceNameAndBhkTypeDto>> getResidenceNameAndBhkType(String microMarketId) {
        log.info("Residence Internal Controller::Processing to get residence name and bhk type");
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<>();
        uriVariables.put("microMarketId", microMarketId);
        String path = UriComponentsBuilder.fromPath("/internal/residence/managed-apartment-info/{microMarketId}").buildAndExpand(uriVariables).toUriString();
        final MultiValueMap<String, String> queryParams = new LinkedMultiValueMap<>();
        final HttpHeaders headerParams = new HttpHeaders();
        final String[] accepts = {
                "*/*"
        ...
        final List<MediaType> accept = restClient.selectHeaderAccept(accepts);
        ParameterizedTypeReference<ResponseDto<List<ResidenceNameAndBhkTypeDto>>> returnType = new ParameterizedTypeReference<ResponseDto<List<ResidenceNameAndBhkTypeDto>>>() {
        };
        return restClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, accept, returnType);
    }
    ...
    public ResponseDto<List<Integer>> getOccupanciesForManagedApartment(String microMarketUuid) {
        ...
        String path = UriComponentsBuilder.fromPath("/internal/residence/managed-apartment/occupancies/{microMarketUuid}").buildAndExpand(uriVariables).toUriString();
        final MultiValueMap<String, String> queryParams = new LinkedMultiValueMap<>();
        final HttpHeaders headerParams = new HttpHeaders();
        final String[] accepts = {
                "*/*"
