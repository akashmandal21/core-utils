...
<<<<<<< HEAD
    ROFR_INTIMATION_FOR_SAME_ROOM_BOOKING("ROFR_INTIMATION_FOR_SAME_DAY_BOOKING"), // mail 1

    ROFR_SECOND_ROOM_CONFIRMATION("ROFR_INTIMATION_FOR_SAME_ROOM_BOOKING"), // mail 2

    ROFR_CURRENT_ROOM_BLOCKED_AFTER_X_HOURS("ROFR_CURRENT_ROOM_BOOKED"), // mail 3

    ROFR_PRIMARY_BOOKING_CONFIRMED_AFTER_X_HOURS("ROFR_PRIMARY_BOOKING_CONFIRMED_AFTER_X_HOURS"), // mail 4

    ROFR_RETENTION_TOKEN_AMOUNT_PAID("ROFR_RETENTION_TOKEN_AMOUNT_PAID"), // mail 5
    ROFR_CONFIRM_PRIMARY_BOOKING("CONFIRM_ROFR_BOOKING"),
    ROFR_CONFIRM_SAME_BED_BOOKING("ROFR_CONFIRM_SAME_BED_BOOKING"), // mail 6

    ROFR_PRIMARY_BOOKING_EXPIRED("ROFR_PRIMARY_BOOKING_EXPIRED"), // mail 7

    ROFR_PRIMARY_BOOKING_CONFIRMED("ROFR_PRIMARY_BOOKING_CONFIRMED"); // mail 8
=======
    AUTO_CARRY_FORWARD_DONE("AUTO_CARRY_FORWARD_DONE"),
    AUTO_CARRY_FORWARD_NOT_DONE("AUTO_CARRY_FORWARD_NOT_DONE");

>>>>>>> 59aa0c81e9be5fad34240f3c37849222d43e68b8
