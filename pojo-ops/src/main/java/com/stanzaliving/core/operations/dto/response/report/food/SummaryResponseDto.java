...
//						.dissatisfied(new FeElementDto(foodRatingBuckets.getDissatisfiedResidents(), foodRatingBuckets.getTotalResidents(), FeElementType.PERCENT_INTEGER))
                        ...
                        .shortage(new FeElementDto(summaryRecordDto.getExperience().getShortage()))
                        .build();
...
//				.onTimeMenuCreation(new FeElementDto(summaryRecordDto.getProcessAdherence().getMenuCreatedOnTime(), summaryRecordDto.getProcessAdherence().getMenuCreatedTimes()))
        ...
        double costMonthProjection = (summaryRecordDto.getCostEfficiency().getTotalMealCost() * DateUtil.getDaysInCurrentMonth()) / DateUtil.getMTDDaysCount();
        double budgetMonthProjection = (summaryRecordDto.getCostEfficiency().getBudgetedMealCost() * DateUtil.getDaysInCurrentMonth()) / DateUtil.getMTDDaysCount();
        this.costEfficiency = CostResponseDto.builder()
                ...
                .costPerMirMonth(new FeElementDto(costMonthProjection, mir, false, FeElementType.CURRENCY_INTEGER))
                .budgetPerMirMonth(new FeElementDto(budgetMonthProjection, mir, false, FeElementType.CURRENCY_INTEGER))
                .build();
