...
public enum ApprovalEntityType {
	...
	SERVICE_MIX_STAY_CURATION("Service Mix Stay Curation", "service-mix-stay", "service-mix-stay"),
	...
	FOOD_MENU_CATEGORY_STAY("Food Menu Category Group", "foodmenucategory", "foodmenucategory"),
	WEEKLY_MENU("Weekly Menu", "FOOD_SERVICE", "WEEKLY_MENU"),
	WEEKLY_MENU_V2("Weekly Menu", "FOOD_SERVICE", "WEEKLY_MENU"),
	WEEKLY_MENU_STAY("Weekly Menu Group", "FOOD_SERVICE", "WEEKLY_MENU"),
